...
var OptimizationBar = function() {
	...
	let leftText = 'Need Attention';
	let rightText = 'Upto Speed';
	let hTextWidth = 0;
	...
	function drawBarLabels(wt, ht) {
		...
		_lText.attr('x', 0).attr('y', (ht * rectYMultiplier/1.25));
		_rText.attr('x', wt - hTextWidth + _barTextMargin).attr('y', (ht * rectYMultiplier/1.25));
	}
